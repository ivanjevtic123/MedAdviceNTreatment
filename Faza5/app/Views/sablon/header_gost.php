...
<head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="/fajlovi/jquery-1.11.3.min.js"> -->
    ...
    <script src="/fajlovi/skript.js"></script>
            ...
            <div class="col-sm-12">
                <nav class="navbar navbar-expand-sm">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?= site_url("Gost/register")?>">REGISTRACIJA</a>
                        </li>
                    </ul>
                </nav>
            </div>
